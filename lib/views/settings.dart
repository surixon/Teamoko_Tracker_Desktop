    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            _sharedPreferences.getString(userType) == "3" ||
                      ...
                      isSwitched
                          ? Column(
                              children: [
                                ...
                                ListTile(
                                  title: const Text('Screen Tracker',
                                      style: TextStyle(color: Colors.black)),
                                  leading: Radio(
                                  ...
                                  trailing: IconButton(
                                    ...
                                    onPressed: () {
                                      _infoAlert('Tracker',
                                          'Team Check-In/Out with tracker app.');
                                    },
                                  ),
                                ),
                                ListTile(
                                  title: const Text('Basic Mannual',
                                      style: TextStyle(color: Colors.black)),
                                  leading: Radio(
                                  ...
                                  trailing: IconButton(
                                    ...
                                    onPressed: () {
                                      _infoAlert('Basic Mannual',
                                          'Check-In/Out without location needed.');
                                    },
                                  ),
                                ),
                                ListTile(
                                  title: const Text(
                                    'Location Based Mannual',
                                    style: TextStyle(color: Colors.black),
                                  ),
                                  leading: Radio(
                                    activeColor: MaterialColor(
                                ...
                                ListTile(
                                  title: const Text(
                                      'Location Based Automatic Beta',
                                      style: TextStyle(color: Colors.black)),
                                  leading: Radio(
                                    value:
                                        AttendenceType.locationBasedAutomatic,
                                    groupValue: _attendenceType,
                                    activeColor: MaterialColor(
                                        0xFFf3396a, CommonColors.color),
                                    onChanged: (AttendenceType value) {
            ...
            GestureDetector(
              onTap: () {
                Navigator.pushNamed(context, RouteConstants.change_password);
              },
              child: Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
